...
import { 
  ...
  Clock, Target, CheckCircle, Brain,
  Heart, Shield, Star
} from 'lucide-react'
  ...
  const programUtama = [
    {
      ...
      features: ['Metode Mutqin', 'Murajaah Rutin', 'Setoran Harian', 'Tes Periodik']
    },
    {
      icon: GraduationCap,
      ...
      features: ['Kurikulum Nasional Plus', 'Laboratorium Lengkap', 'Bimbingan Belajar', 'Ektrakurikuler']
    },
    {
      icon: Users,
      ...
      features: ['Kitab Standar Pesantren', 'Sorogan & Bandongan', 'Bahasa Arab Aktif', 'Praktek Ibadah']
    },
    {
      icon: Award,
      ...
      features: ['Kepemimpinan', 'Olahraga & Seni', 'Kewirausahaan', 'IT & Digital']
    }
  ]
    ...
    <div className="pt-20">
      ...
      <section className="py-20 bg-gradient-to-br from-blue-50 to-green-50">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-5xl md:text-6xl font-bold mb-6 text-blue-800">Program Pendidikan</h1>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Kurikulum lengkap yang mengintegrasikan ilmu agama, ilmu umum, dan pembinaan karakter
          </p>
        </div>
      </section>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Program pendidikan komprehensif untuk pengembangan santri secara holistik
            </p>
          </div>
              ...
              return (
                ...
                >
                  ...
                  <div className="pt-4 border-t border-gray-100">
                    <h4 className="text-sm font-semibold mb-3 text-gray-700">Fitur Program:</h4>
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-4">Kitab yang Diajarkan</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Kurikulum pembelajaran ilmu-ilmu Islam klasik dengan kitab standar pesantren
            </p>
          </div>
            ...
            {[
              ...
              <div key={index} className="bg-white rounded-2xl shadow-lg p-8">
                <div className="flex items-center mb-6">
                  ...
                  <h3 className="text-xl font-bold text-blue-800">{kategori.kategori}</h3>
                </div>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-4">Metode Pembelajaran</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            ...
            {[
              {
                ...
                description: 'Mengintegrasikan nilai-nilai Islam dalam semua mata pelajaran',
              ...
              },
              {
                ...
                steps: ['Bimbingan Individual', 'Konseling Rutin', 'Evaluasi Berkala', 'Rapor Perkembangan']
              },
              {
                icon: Heart,
                title: 'Pendidikan Karakter',
                description: 'Internalisasi nilai-nilai islam dalam kehidupan sehari-hari',
              ...
              },
              {
                ...
                steps: ['Aturan Jelas', 'Konsistensi', 'Reward System', 'Pembinaan']
              }
            ].map((metode, index) => {
              ...
              return (
                <div key={index} className="bg-white rounded-2xl shadow-lg p-8">
                  ...
                  <h3 className="text-xl font-bold mb-4 text-center">{metode.title}</h3>
                  <p className="text-gray-600 mb-6 text-center">{metode.description}</p>
